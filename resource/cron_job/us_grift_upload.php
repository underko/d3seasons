<?php
    ...
    if (file_get_contents("../globals/global-us.var") == "1") {
        echo "US script already running -> Skipping this one.<br>";
    }
    else {
        echo "First run of the US script -> Changing global variable.<br>";
    ...
    function script_run_us()
    {
        ...
        $log = "        Uploading of US statistics done.\n";
        file_put_contents($log_file, $log, FILE_APPEND | LOCK_EX);
