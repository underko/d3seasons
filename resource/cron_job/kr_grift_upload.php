<?php
    ...
    {
        world_upload_log("   Uploading KR statistics ...\n");
        $date = time();
        $total_err_value = 0;
        ...
        /* hc season */
        $err_value = 0;
        $tmp_b_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-barbarian"), true);
        ...
        $err_value = 0;
        $tmp_c_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-crusader"), true);
        while ($tmp_c_hc_s['top_level'] == 0 || $tmp_c_hc_s['avg_level'] == 0 || $tmp_c_hc_s['end_level'] == 0) {
            $tmp_c_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-crusader"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_d_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-dh"), true);
        while ($tmp_d_hc_s['top_level'] == 0 || $tmp_d_hc_s['avg_level'] == 0 || $tmp_d_hc_s['end_level'] == 0) {
            $tmp_d_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-dh"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_m_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-monk"), true);
        while ($tmp_m_hc_s['top_level'] == 0 || $tmp_m_hc_s['avg_level'] == 0 || $tmp_m_hc_s['end_level'] == 0) {
            $tmp_m_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-monk"), true);
            if ($err_value++ > 5) { $total_err_value++;break; }
        }
        $err_value = 0;
        $tmp_wd_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-wd"), true);
        while ($tmp_wd_hc_s['top_level'] == 0 || $tmp_wd_hc_s['avg_level'] == 0 || $tmp_wd_hc_s['end_level'] == 0) {
            $tmp_wd_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-wd"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_wz_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-wizard"), true);
        ...
        /* hc non season */
        $err_value = 0;
        $tmp_b_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-barbarian"), true);
        while ($tmp_b_hc_ns['top_level'] == 0 || $tmp_b_hc_ns['avg_level'] == 0 || $tmp_b_hc_ns['end_level'] == 0) {
            $tmp_b_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-barbarian"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_c_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-crusader"), true);
        while ($tmp_c_hc_ns['top_level'] == 0 || $tmp_c_hc_ns['avg_level'] == 0 || $tmp_c_hc_ns['end_level'] == 0) {
            $tmp_c_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-crusader"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_d_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-dh"), true);
        while ($tmp_d_hc_ns['top_level'] == 0 || $tmp_d_hc_ns['avg_level'] == 0 || $tmp_d_hc_ns['end_level'] == 0) {
            $tmp_d_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-dh"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_m_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-monk"), true);
        while ($tmp_m_hc_ns['top_level'] == 0 || $tmp_m_hc_ns['avg_level'] == 0 || $tmp_m_hc_ns['end_level'] == 0) {
            $tmp_m_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-monk"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_wd_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-wd"), true);
        while ($tmp_wd_hc_ns['top_level'] == 0 || $tmp_wd_hc_ns['avg_level'] == 0 || $tmp_wd_hc_ns['end_level'] == 0) {
            $tmp_wd_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-wd"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_wz_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-wizard"), true);
        ...
        /* sc season */
        $err_value = 0;
        $tmp_b_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-barbarian"), true);
        while ($tmp_b_sc_s['top_level'] == 0 || $tmp_b_sc_s['avg_level'] == 0 || $tmp_b_sc_s['end_level'] == 0) {
            $tmp_b_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-barbarian"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_c_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-crusader"), true);
        while ($tmp_c_sc_s['top_level'] == 0 || $tmp_c_sc_s['avg_level'] == 0 || $tmp_c_sc_s['end_level'] == 0) {
            $tmp_c_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-crusader"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_d_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-dh"), true);
        while ($tmp_d_sc_s['top_level'] == 0 || $tmp_d_sc_s['avg_level'] == 0 || $tmp_d_sc_s['end_level'] == 0) {
            $tmp_d_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-dh"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_m_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-monk"), true);
        while ($tmp_m_sc_s['top_level'] == 0 || $tmp_m_sc_s['avg_level'] == 0 || $tmp_m_sc_s['end_level'] == 0) {
            $tmp_m_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-monk"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_wd_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-wd"), true);
        while ($tmp_wd_sc_s['top_level'] == 0 || $tmp_wd_sc_s['avg_level'] == 0 || $tmp_wd_sc_s['end_level'] == 0) {
            $tmp_wd_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-wd"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_wz_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-wizard"), true);
        ...
        /* sc non season */
        $err_value = 0;
        $tmp_b_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-barbarian"), true);
        while ($tmp_b_sc_ns['top_level'] == 0 || $tmp_b_sc_ns['avg_level'] == 0 || $tmp_b_sc_ns['end_level'] == 0) {
            $tmp_b_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-barbarian"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_c_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-crusader"), true);
        while ($tmp_c_sc_ns['top_level'] == 0 || $tmp_c_sc_ns['avg_level'] == 0 || $tmp_c_sc_ns['end_level'] == 0) {
            $tmp_c_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-crusader"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_d_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-dh"), true);
        while ($tmp_d_sc_ns['top_level'] == 0 || $tmp_d_sc_ns['avg_level'] == 0 || $tmp_d_sc_ns['end_level'] == 0) {
            $tmp_d_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-dh"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_m_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-monk"), true);
        while ($tmp_m_sc_ns['top_level'] == 0 || $tmp_m_sc_ns['avg_level'] == 0 || $tmp_m_sc_ns['end_level'] == 0) {
            $tmp_m_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-monk"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_wd_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-wd"), true);
        while ($tmp_wd_sc_ns['top_level'] == 0 || $tmp_wd_sc_ns['avg_level'] == 0 || $tmp_wd_sc_ns['end_level'] == 0) {
            $tmp_wd_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-wd"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_wz_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-wizard"), true);
        ...
        /* team hc season */
        $err_value = 0;
        $tmp_t2_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-team-2"), true);
        while ($tmp_t2_hc_s['top_level'] == 0 || $tmp_t2_hc_s['avg_level'] == 0 || $tmp_t2_hc_s['end_level'] == 0) {
            $tmp_t2_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-team-2"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_t3_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-team-3"), true);
        while ($tmp_t3_hc_s['top_level'] == 0 || $tmp_t3_hc_s['avg_level'] == 0 || $tmp_t3_hc_s['end_level'] == 0) {
            $tmp_t3_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-team-3"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_t4_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-hardcore-team-4"), true);
        ...
        /* team hc non season */
        $err_value = 0;
        $tmp_t2_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-team-2"), true);
        while ($tmp_t2_hc_ns['top_level'] == 0 || $tmp_t2_hc_ns['avg_level'] == 0 || $tmp_t2_hc_ns['end_level'] == 0) {
            $tmp_t2_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-team-2"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_t3_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-team-3"), true);
        while ($tmp_t3_hc_ns['top_level'] == 0 || $tmp_t3_hc_ns['avg_level'] == 0 || $tmp_t3_hc_ns['end_level'] == 0) {
            $tmp_t3_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-team-3"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_t4_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-hardcore-team-4"), true);
        ...
        /* team sc season */
        $err_value = 0;
        $tmp_t2_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-team-2"), true);
        while ($tmp_t2_sc_s['top_level'] == 0 || $tmp_t2_sc_s['avg_level'] == 0 || $tmp_t2_sc_s['end_level'] == 0) {
            $tmp_t2_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-team-2"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_t3_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-team-3"), true);
        while ($tmp_t3_sc_s['top_level'] == 0 || $tmp_t3_sc_s['avg_level'] == 0 || $tmp_t3_sc_s['end_level'] == 0) {
            $tmp_t3_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-team-3"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_t4_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/season/1/rift-team-4"), true);
        ...
        /* team sc non season */
        $err_value = 0;
        $tmp_t2_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-team-2"), true);
        while ($tmp_t2_sc_ns['top_level'] == 0 || $tmp_t2_sc_ns['avg_level'] == 0 || $tmp_t2_sc_ns['end_level'] == 0) {
            $tmp_t2_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-team-2"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_t3_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-team-3"), true);
        while ($tmp_t3_sc_ns['top_level'] == 0 || $tmp_t3_sc_ns['avg_level'] == 0 || $tmp_t3_sc_ns['end_level'] == 0) {
            $tmp_t3_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-team-3"), true);
            if ($err_value++ > 5) { $total_err_value++; break; }
        }
        $err_value = 0;
        $tmp_t4_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/en/rankings/era/1/rift-team-4"), true);
        ...
        world_upload_log("        Uploading of KR statistics done.\n");
