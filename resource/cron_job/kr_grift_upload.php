<?php
    ...
    if (file_get_contents("../globals/global-kr.var") == "1") {
        echo "KR script already running -> Skipping execution.<br>";
    }
    else {
        echo "First run of the KR script -> Changing global variable.<br>";

        /* set max execution time to 5m due to script nature */
        ini_set('max_execution_time', 300);
        ini_set("log_errors", 1);
        ini_set("error_log", "../logs/kr_upload.log");
        
        file_put_contents("../globals/global-kr.var", "1");

        script_run_kr();
    }

    function script_run_kr()
    {
        $date = time();
        $log_file = "../logs/log";
        $err_value = 0;
        ...
        /* parsing rankings */
        $log .= "   Uploading KR statistics ...\n";
        echo $log . "<br>";
        file_put_contents($log_file, $log, FILE_APPEND | LOCK_EX);

        /* UPLOAD SOLO DATA */
        /* hc season */
        $tmp_b_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-barbarian"), true);
        while ($tmp_b_hc_s['top_level'] == 0 || $tmp_b_hc_s['avg_level'] == 0 || $tmp_b_hc_s['end_level'] == 0) {
            $tmp_b_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-barbarian"), true);
            $err_value++;
        }

        $tmp_c_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-crusader"), true);
        while ($tmp_c_hc_s['top_level'] == 0 || $tmp_c_hc_s['avg_level'] == 0 || $tmp_c_hc_s['end_level'] == 0) {
            $tmp_c_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-crusader"), true);
            $err_value++;
        }

        $tmp_d_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-dh"), true);
        while ($tmp_d_hc_s['top_level'] == 0 || $tmp_d_hc_s['avg_level'] == 0 || $tmp_d_hc_s['end_level'] == 0) {
            $tmp_d_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-dh"), true);
            $err_value++;
        }

        $tmp_m_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-monk"), true);
        while ($tmp_m_hc_s['top_level'] == 0 || $tmp_m_hc_s['avg_level'] == 0 || $tmp_m_hc_s['end_level'] == 0) {
            $tmp_m_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-monk"), true);
            $err_value++;
        }

        $tmp_wd_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-wd"), true);
        while ($tmp_wd_hc_s['top_level'] == 0 || $tmp_wd_hc_s['avg_level'] == 0 || $tmp_wd_hc_s['end_level'] == 0) {
            $tmp_wd_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-wd"), true);
            $err_value++;
        }

        $tmp_wz_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-wizard"), true);
        ...
        $query = "INSERT INTO kr_hardcore_season (
                      date,
        ...
        /* hc non season */
        $tmp_b_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-barbarian"), true);
        while ($tmp_b_hc_ns['top_level'] == 0 || $tmp_b_hc_ns['avg_level'] == 0 || $tmp_b_hc_ns['end_level'] == 0) {
            $tmp_b_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-barbarian"), true);
            $err_value++;
        }

        $tmp_c_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-crusader"), true);
        while ($tmp_c_hc_ns['top_level'] == 0 || $tmp_c_hc_ns['avg_level'] == 0 || $tmp_c_hc_ns['end_level'] == 0) {
            $tmp_c_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-crusader"), true);
            $err_value++;
        }

        $tmp_d_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-dh"), true);
        while ($tmp_d_hc_ns['top_level'] == 0 || $tmp_d_hc_ns['avg_level'] == 0 || $tmp_d_hc_ns['end_level'] == 0) {
            $tmp_d_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-dh"), true);
            $err_value++;
        }

        $tmp_m_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-monk"), true);
        while ($tmp_m_hc_ns['top_level'] == 0 || $tmp_m_hc_ns['avg_level'] == 0 || $tmp_m_hc_ns['end_level'] == 0) {
            $tmp_m_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-monk"), true);
            $err_value++;
        }

        $tmp_wd_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-wd"), true);
        while ($tmp_wd_hc_ns['top_level'] == 0 || $tmp_wd_hc_ns['avg_level'] == 0 || $tmp_wd_hc_ns['end_level'] == 0) {
            $tmp_wd_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-wd"), true);
            $err_value++;
        }

        $tmp_wz_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-wizard"), true);
        ...
        $query = "INSERT INTO kr_hardcore_non_season (
                      date,
                      barbarian_top, crusader_top, dh_top, monk_top, wd_top, wizard_top,
                      barbarian_end, crusader_end, dh_end, monk_end, wd_end, wizard_end,
                      barbarian_avg, crusader_avg, dh_avg, monk_avg, wd_avg, wizard_avg)
        ...
        /* sc season */
        $tmp_b_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-barbarian"), true);
        while ($tmp_b_sc_s['top_level'] == 0 || $tmp_b_sc_s['avg_level'] == 0 || $tmp_b_sc_s['end_level'] == 0) {
            $tmp_b_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-barbarian"), true);
            $err_value++;
        }

        $tmp_c_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-crusader"), true);
        while ($tmp_c_sc_s['top_level'] == 0 || $tmp_c_sc_s['avg_level'] == 0 || $tmp_c_sc_s['end_level'] == 0) {
            $tmp_c_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-crusader"), true);
            $err_value++;
        }

        $tmp_d_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-dh"), true);
        while ($tmp_d_sc_s['top_level'] == 0 || $tmp_d_sc_s['avg_level'] == 0 || $tmp_d_sc_s['end_level'] == 0) {
            $tmp_d_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-dh"), true);
            $err_value++;
        }

        $tmp_m_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-monk"), true);
        while ($tmp_m_sc_s['top_level'] == 0 || $tmp_m_sc_s['avg_level'] == 0 || $tmp_m_sc_s['end_level'] == 0) {
            $tmp_m_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-monk"), true);
            $err_value++;
        }

        $tmp_wd_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-wd"), true);
        while ($tmp_wd_sc_s['top_level'] == 0 || $tmp_wd_sc_s['avg_level'] == 0 || $tmp_wd_sc_s['end_level'] == 0) {
            $tmp_wd_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-wd"), true);
            $err_value++;
        }

        $tmp_wz_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-wizard"), true);
        ...
        $query = "INSERT INTO kr_softcore_season (
                      date,
                      barbarian_top, crusader_top, dh_top, monk_top, wd_top, wizard_top,
                      barbarian_end, crusader_end, dh_end, monk_end, wd_end, wizard_end,
                      barbarian_avg, crusader_avg, dh_avg, monk_avg, wd_avg, wizard_avg)
        ...
        /* sc non season */
        $tmp_b_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-barbarian"), true);
        while ($tmp_b_sc_ns['top_level'] == 0 || $tmp_b_sc_ns['avg_level'] == 0 || $tmp_b_sc_ns['end_level'] == 0) {
            $tmp_b_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-barbarian"), true);
            $err_value++;
        }

        $tmp_c_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-crusader"), true);
        while ($tmp_c_sc_ns['top_level'] == 0 || $tmp_c_sc_ns['avg_level'] == 0 || $tmp_c_sc_ns['end_level'] == 0) {
            $tmp_c_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-crusader"), true);
            $err_value++;
        }

        $tmp_d_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-dh"), true);
        while ($tmp_d_sc_ns['top_level'] == 0 || $tmp_d_sc_ns['avg_level'] == 0 || $tmp_d_sc_ns['end_level'] == 0) {
            $tmp_d_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-dh"), true);
            $err_value++;
        }

        $tmp_m_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-monk"), true);
        while ($tmp_m_sc_ns['top_level'] == 0 || $tmp_m_sc_ns['avg_level'] == 0 || $tmp_m_sc_ns['end_level'] == 0) {
            $tmp_m_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-monk"), true);
            $err_value++;
        }

        $tmp_wd_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-wd"), true);
        while ($tmp_wd_sc_ns['top_level'] == 0 || $tmp_wd_sc_ns['avg_level'] == 0 || $tmp_wd_sc_ns['end_level'] == 0) {
            $tmp_wd_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-wd"), true);
            $err_value++;
        }

        $tmp_wz_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-wizard"), true);
        ...
        $query = "INSERT INTO kr_softcore_non_season (
                      date,
                      barbarian_top, crusader_top, dh_top, monk_top, wd_top, wizard_top,
                      barbarian_end, crusader_end, dh_end, monk_end, wd_end, wizard_end,
                      barbarian_avg, crusader_avg, dh_avg, monk_avg, wd_avg, wizard_avg)
        ...
        /* UPLOAD TEAM DATA */
        /* team hc season */
        $tmp_t2_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-team-2"), true);
        while ($tmp_t2_hc_s['top_level'] == 0 || $tmp_t2_hc_s['avg_level'] == 0 || $tmp_t2_hc_s['end_level'] == 0) {
            $tmp_t2_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-team-2"), true);
            $err_value++;
        }

        $tmp_t3_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-team-3"), true);
        while ($tmp_t3_hc_s['top_level'] == 0 || $tmp_t3_hc_s['avg_level'] == 0 || $tmp_t3_hc_s['end_level'] == 0) {
            $tmp_t3_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-team-3"), true);
            $err_value++;
        }

        $tmp_t4_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-team-4"), true);
        while ($tmp_t4_hc_s['top_level'] == 0 || $tmp_t4_hc_s['avg_level'] == 0 || $tmp_t4_hc_s['end_level'] == 0) {
            $tmp_t4_hc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-hardcore-team-4"), true);
            $err_value++;
        }

        $query = "INSERT INTO kr_hardcore_season_team (
                          date,
        ...
        /* team hc non season */
        $tmp_t2_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-team-2"), true);
        while ($tmp_t2_hc_ns['top_level'] == 0 || $tmp_t2_hc_ns['avg_level'] == 0 || $tmp_t2_hc_ns['end_level'] == 0) {
            $tmp_t2_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-team-2"), true);
            $err_value++;
        }

        $tmp_t3_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-team-3"), true);
        while ($tmp_t3_hc_ns['top_level'] == 0 || $tmp_t3_hc_ns['avg_level'] == 0 || $tmp_t3_hc_ns['end_level'] == 0) {
            $tmp_t3_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-team-3"), true);
            $err_value++;
        }

        $tmp_t4_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-team-4"), true);
        while ($tmp_t4_hc_ns['top_level'] == 0 || $tmp_t4_hc_ns['avg_level'] == 0 || $tmp_t4_hc_ns['end_level'] == 0) {
            $tmp_t4_hc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-hardcore-team-4"), true);
            $err_value++;
        }

        $query = "INSERT INTO kr_hardcore_non_season_team (
                          date,
                          team_2_top, team_3_top, team_4_top,
                          team_2_avg, team_3_avg, team_4_avg,
                          team_2_end, team_3_end, team_4_end )
        ...
        /* team sc season */
        $tmp_t2_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-team-2"), true);
        while ($tmp_t2_sc_s['top_level'] == 0 || $tmp_t2_sc_s['avg_level'] == 0 || $tmp_t2_sc_s['end_level'] == 0) {
            $tmp_t2_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-team-2"), true);
            $err_value++;
        }

        $tmp_t3_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-team-3"), true);
        while ($tmp_t3_sc_s['top_level'] == 0 || $tmp_t3_sc_s['avg_level'] == 0 || $tmp_t3_sc_s['end_level'] == 0) {
            $tmp_t3_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-team-3"), true);
            $err_value++;
        }

        $tmp_t4_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-team-4"), true);
        while ($tmp_t4_sc_s['top_level'] == 0 || $tmp_t4_sc_s['avg_level'] == 0 || $tmp_t4_sc_s['end_level'] == 0) {
            $tmp_t4_sc_s = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/season/1/rift-team-4"), true);
            $err_value++;
        }

        $query = "INSERT INTO kr_softcore_season_team (
                          date,
                          team_2_top, team_3_top, team_4_top,
                          team_2_avg, team_3_avg, team_4_avg,
                          team_2_end, team_3_end, team_4_end )
        ...
        /* team sc non season */
        $tmp_t2_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-team-2"), true);
        while ($tmp_t2_sc_ns['top_level'] == 0 || $tmp_t2_sc_ns['avg_level'] == 0 || $tmp_t2_sc_ns['end_level'] == 0) {
            $tmp_t2_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-team-2"), true);
            $err_value++;
        }

        $tmp_t3_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-team-3"), true);
        while ($tmp_t3_sc_ns['top_level'] == 0 || $tmp_t3_sc_ns['avg_level'] == 0 || $tmp_t3_sc_ns['end_level'] == 0) {
            $tmp_t3_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-team-3"), true);
            $err_value++;
        }

        $tmp_t4_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-team-4"), true);
        while ($tmp_t4_sc_ns['top_level'] == 0 || $tmp_t4_sc_ns['avg_level'] == 0 || $tmp_t4_sc_ns['end_level'] == 0) {
            $tmp_t4_sc_ns = json_decode(get_stat_json("http://kr.battle.net/d3/ko/rankings/era/1/rift-team-4"), true);
            $err_value++;
        }

        $query = "INSERT INTO kr_softcore_non_season_team (
                          date,
                          team_2_top, team_3_top, team_4_top,
                          team_2_avg, team_3_avg, team_4_avg,
                          team_2_end, team_3_end, team_4_end )
        ...
        $log = "        Uploading of KR statistics done.\n";
        file_put_contents($log_file, $log, FILE_APPEND | LOCK_EX);
